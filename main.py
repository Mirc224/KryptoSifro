...
if __name__ == '__main__':
    # crack(".\SifrovaneTexty\\affinna_sifrovane.txt",".\Texty\\SJ_tele.txt", 27)
    # text = KU.textToTelegraphAlphabet(KU.readFile('.\Koincidencia\\text2.txt'))
    text = KU.textToTelegraphAlphabet(KU.readFile('.\Texty\\EN_ASCII.txt'))
